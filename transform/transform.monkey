'Saving and re-using transformation matrices

'By saving a transformation matrix, you can re-use it to apply a long sequence of rotations, scales and translations repeatedly.
