...
Class BoingApp Extends App
	...
	Method OnCreate()
		...
		levels.AddLast (New Level( 
										[-180.0,-140,180,-140,0,140],
										[0,1,1,2,2,0],
										[-149.0,-122,1, 131,-117,1, 121,104,1, -146,122,1, -7,-8,0]))
		
		levels.AddLast (New Level(
										[-50.0,-50,-50,50,50,-50,50,50],
										[0,1,0,2,1,3,2,3],
										[-124.0,51,1, -99,-38,1, -47,-84,1, 54,-83,1, 108,-34,1, 130,45,1, 3,1,1, -42,28,0, 41,26,0]))
